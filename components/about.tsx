          ...
          <div className="grid gap-16 md:grid-cols-2 text-white text-base">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg">motiongeostar@gmail.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-6 h-6 text-gray-400" />
                  <span className="text-lg">+82 (10) 4853-9485</span>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin className="w-6 h-6 text-gray-400" />
                  <span className="text-lg">Seoul, Korea</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-6">
                <img src="/tools/c4d.png" alt="Cinema 4D" className="h-12 md:h-12 w-auto" />
                <img src="/tools/redshift.png" alt="Redshift" className="h-12 md:h-12 w-auto" />
                <img src="/tools/octane.png" alt="Octane" className="h-12 md:h-12 w-auto" />
